...
@onready var job_text: RichTextLabel = $PanelContainer/VBoxContainer/MarginContainer/RichTextLabel
...
func _on_forward_button_pressed() -> void:
	if job_text.text == dock_worker_description:
		job_text.text = store_clerk_description
	else:
		job_text.text = dock_worker_description
